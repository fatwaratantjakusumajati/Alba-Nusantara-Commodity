...
const translations: Record<string, Record<Language, string>> = {
  ...
  "prod.cocoa.step2.desc": { id: "Buah kakao dipecah dan biji diekstraksi secara manual. Biji langsung dipisahkan dari pulp tanpa melalui proses fermentasi.", en: "Cocoa pods are broken and the beans are manually extracted. Beans are immediately separated from the pulp without undergoing fermentation." },
  "prod.cocoa.step3.title": { id: "Pencucian & Pemisahan Pulp", en: "Washing & Pulp Separation" },
  "prod.cocoa.step3.desc": { id: "Biji kakao dicuci untuk menghilangkan sisa lendir dan pulp yang menempel. Proses ini memastikan biji bersih dan siap untuk pengeringan langsung.", en: "Cocoa beans are washed to remove residual mucilage and pulp. This process ensures the beans are clean and ready for direct drying." },
  "prod.cocoa.step4.title": { id: "Pengeringan Langsung", en: "Direct Sun Drying" },
  "prod.cocoa.step4.desc": { id: "Biji kakao langsung dijemur di bawah sinar matahari selama 5-7 hari tanpa fermentasi hingga kadar air mencapai 7-8% untuk penyimpanan optimal.", en: "Cocoa beans are directly sun-dried for 5-7 days without fermentation until the moisture content reaches 7-8% for optimal storage." },
